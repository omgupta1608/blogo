    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $.each(data, function(index, element) {
                ...
                var post = '<div class="card" style="width: 18rem;"><div class="post-body"><h5 class="post-content">' + element.content + '</h5><p class="post-date">' + element.date_time + '</p><a class="btn btn-primary">Like</a><h5 class="post-likes">' + element.likes_count + '</h5></div></div>';
                $('#posts').append(post);
